    ...
    public partial class ErrorMessageCheck : Form
    {
        ...
        private string GetMessage(string line)
        {
           ...
           "RecurDynモデルにおいて、ベース/アクションマーカーにズレがないか確認ください。" + "\n" +
            ...
            //エラーが見つからない場合
            message[38, 0] = "RecurDyn Solver has encountered a problem";
            message[38, 1] = "解析開始時または解析実行中に問題が発生しましたが、該当するエラーメッセージを発見することができませんでした。" + "\r\n" +
                "メッセージファイル(*.msg)を技術サポートにご送付ください。" + "\r\n" +
                "◇RecurDyn技術サポートのメールアドレス" + "\r\n" + "rdsup@functionbay.co.jp";

            message[39, 0] = "Analysis is accomplished successfully";
            message[39, 1] = "計算は正常に終了しました。";
